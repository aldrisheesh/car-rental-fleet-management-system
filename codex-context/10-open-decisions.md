...
Deferred: scheduled pickup/return/overdue/maintenance/low-availability reminders, external email/SMS/push, notification preferences, escalation, and retention rules.
...
Scheduled reminders, audit, operational context, reports/dashboard canonicalization, role/mobile UX validation, demo data, and unresolved settlement remain pending.
