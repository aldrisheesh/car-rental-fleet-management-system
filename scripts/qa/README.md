...
- Forecast, supply-evaluation, allocation-recommendation, organic demand history, notification, audit/security, backup, and recovery data are out of scope. Forecasting remains honestly empty unless populated through a separately authorized explicit fixture/test path.
